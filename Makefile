...
.PHONY: base kind go-app curl webserver psql mongo prometheus loki ssh-keys
base kind go-app curl webserver psql mongo prometheus loki ssh-keys: check-host
...
help:
	...
	@echo ""
	@echo "Challenges:"
	@echo "  base, kind, go-app, curl, webserver, psql, mongo, prometheus, loki ssh-keys"
	@echo ""
	@echo "Terraform EC2:"
