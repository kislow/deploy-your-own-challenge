...
.PHONY: base kind go-app curl tinyapi webserver psql mongo prometheus loki tfdocker ssh-keys
base kind go-app curl tinyapi webserver psql mongo prometheus loki tfdocker ssh-keys: check-host
...
help:
	...
	@echo ""
	@echo "Challenges:"
	@echo "  base, kind, go-app, curl, webserver, tinyapi, psql, mongo, prometheus, loki, terraform, ssh-keys"
	@echo ""
	@echo "Terraform EC2:"
